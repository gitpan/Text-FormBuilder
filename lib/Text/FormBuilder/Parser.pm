...
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args)
sub Parse::RecDescent::Text::FormBuilder::Parser::_alternation_1_of_production_1_of_rule_type
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
	$ERRORS = 0;
	my $thisrule = $thisparser->{"rules"}{"_alternation_1_of_production_1_of_rule_type"};
	
	Parse::RecDescent::_trace(q{Trying rule: [_alternation_1_of_production_1_of_rule_type]},
				  Parse::RecDescent::_tracefirst($_[1]),
				  q{_alternation_1_of_production_1_of_rule_type},
				  $tracelevel)
					if defined $::RD_TRACE;
	...
	while (!$_matched && !$commit)
	{
		...
		$text = $_[1];
		my $_savetext;
		@item = (q{_alternation_1_of_production_1_of_rule_type});
		%item = (__RULE__ => q{_alternation_1_of_production_1_of_rule_type});
		my $repcount = 0;
	...
	while (!$_matched && !$commit)
	{
		...
		$_tok = ($_noactions) ? 0 : do { warn "[Text::FormBuilder] Using field group names directly is not (yet) supported (input line $thisline)\n"; 'text' };
		unless (defined $_tok)
		{
			Parse::RecDescent::_trace(q{<<Didn't match action>> (return value: [undef])})
					if defined $::RD_TRACE;
...
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args)
sub Parse::RecDescent::Text::FormBuilder::Parser::validate_def
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
	$ERRORS = 0;
	my $thisrule = $thisparser->{"rules"}{"validate_def"};
	
	Parse::RecDescent::_trace(q{Trying rule: [validate_def]},
				  Parse::RecDescent::_tracefirst($_[1]),
				  q{validate_def},
				  $tracelevel)
					if defined $::RD_TRACE;
	...
	while (!$_matched && !$commit)
	{
		...
		Parse::RecDescent::_trace(q{Trying production: ['!validate' var_name <perl_codeblock>]},
					  Parse::RecDescent::_tracefirst($_[1]),
					  q{validate_def},
					  $tracelevel)
						if defined $::RD_TRACE;
		...
		my $_savetext;
		@item = (q{validate_def});
		%item = (__RULE__ => q{validate_def});
		my $repcount = 0;


		Parse::RecDescent::_trace(q{Trying terminal: ['!validate']},
					  Parse::RecDescent::_tracefirst($text),
					  q{validate_def},
					  $tracelevel)
						if defined $::RD_TRACE;
		...
		Parse::RecDescent::_trace(q{>>Matched production: ['!validate' var_name <perl_codeblock>]<<},
					  Parse::RecDescent::_tracefirst($text),
					  q{validate_def},
					  $tracelevel)
						if defined $::RD_TRACE;
...
sub Parse::RecDescent::Text::FormBuilder::Parser::_alternation_1_of_production_1_of_rule_form_spec
{
	...
	while (!$_matched && !$commit)
	{
		...
		Parse::RecDescent::_trace(q{Trying production: [validate_def]},
					  Parse::RecDescent::_tracefirst($_[1]),
					  q{_alternation_1_of_production_1_of_rule_form_spec},
					  $tracelevel)
						if defined $::RD_TRACE;
		...
		Parse::RecDescent::_trace(q{Trying subrule: [validate_def]},
				  Parse::RecDescent::_tracefirst($text),
				  q{_alternation_1_of_production_1_of_rule_form_spec},
				  $tracelevel)
					if defined $::RD_TRACE;
		if (1) { no strict qw{refs};
		$expectation->is(q{})->at($text);
		unless (defined ($_tok = Parse::RecDescent::Text::FormBuilder::Parser::validate_def($thisparser,$text,$repeating,$_noactions,sub { \@arg })))
		{
			
			Parse::RecDescent::_trace(q{<<Didn't match subrule: [validate_def]>>},
						  Parse::RecDescent::_tracefirst($text),
						  q{_alternation_1_of_production_1_of_rule_form_spec},
						  $tracelevel)
							if defined $::RD_TRACE;
		...
		Parse::RecDescent::_trace(q{>>Matched subrule: [validate_def]<< (return value: [}
					. $_tok . q{]},
					  ...
					  $tracelevel)
						if defined $::RD_TRACE;
		$item{q{validate_def}} = $_tok;
		push @item, $_tok;
		
		}


		Parse::RecDescent::_trace(q{>>Matched production: [validate_def]<<},
					  Parse::RecDescent::_tracefirst($text),
					  q{_alternation_1_of_production_1_of_rule_form_spec},
					  $tracelevel)
						if defined $::RD_TRACE;
...
sub Parse::RecDescent::Text::FormBuilder::Parser::type
{
	...
	while (!$_matched && !$commit)
	{
		...
		Parse::RecDescent::_trace(q{Trying production: [':' builtin_field, or var_name]},
					  Parse::RecDescent::_tracefirst($_[1]),
					  q{type},
					  $tracelevel)
						if defined $::RD_TRACE;
		...
		Parse::RecDescent::_trace(q{Trying subrule: [_alternation_1_of_production_1_of_rule_type]},
				  Parse::RecDescent::_tracefirst($text),
				  q{type},
				  $tracelevel)
					if defined $::RD_TRACE;
		if (1) { no strict qw{refs};
		$expectation->is(q{builtin_field, or var_name})->at($text);
		unless (defined ($_tok = Parse::RecDescent::Text::FormBuilder::Parser::_alternation_1_of_production_1_of_rule_type($thisparser,$text,$repeating,$_noactions,sub { \@arg })))
		{
			
			Parse::RecDescent::_trace(q{<<Didn't match subrule: [_alternation_1_of_production_1_of_rule_type]>>},
						  Parse::RecDescent::_tracefirst($text),
						  q{type},
						  $tracelevel)
							if defined $::RD_TRACE;
		...
		Parse::RecDescent::_trace(q{>>Matched subrule: [_alternation_1_of_production_1_of_rule_type]<< (return value: [}
					. $_tok . q{]},
					  ...
					  $tracelevel)
						if defined $::RD_TRACE;
		$item{q{_alternation_1_of_production_1_of_rule_type}} = $_tok;
		push @item, $_tok;
		
		}


		Parse::RecDescent::_trace(q{>>Matched production: [':' builtin_field, or var_name]<<},
					  Parse::RecDescent::_tracefirst($text),
					  q{type},
					  $tracelevel)
						if defined $::RD_TRACE;
...
package Text::FormBuilder::Parser; sub new { my $self = bless( {
	...
	@group = ();
                              ...
                              '_alternation_1_of_production_1_of_rule_type' => bless( {
                                                                                        'impcount' => 0,
                                                                                        'calls' => [
                                                                                                     'builtin_field',
                                                                                                     'var_name'
                                                                                                     ...
                                                                                                     bless( {
                                                                                                              ...
                                                                                                              'items' => [
                                                                                                                           ...
                                                                                                                           bless( {
                                                                                                                                    ...
                                                                                                                                    'lookahead' => 0,
                                                                                                                                    'line' => 252,
                                                                                                                                    'code' => '{ warn "[Text::FormBuilder] Using field group names directly is not (yet) supported (input line $thisline)\\n"; \'text\' }'
                                                                                                                                  }, 'Parse::RecDescent::Action' )
                                                                                                                         ],
                                                                                                              'line' => 252
                                                                                                            }, 'Parse::RecDescent::Production' )
                                                                                                   ],
                                                                                        'name' => '_alternation_1_of_production_1_of_rule_type',
                                                                                        'vars' => '',
                                                                                        'line' => 252
                                                                                      }, 'Parse::RecDescent::Rule' ),
	...
	$return = {
	    ...
	    sections => \\@sections,
                              ...
                              'type' => bless( {
                                                 'impcount' => 1,
                                                 'calls' => [
                                                              '_alternation_1_of_production_1_of_rule_type'
                                                            ],
                                                 'changed' => 0,
                                                 'opcount' => 0,
                                                 'prods' => [
                                                              bless( {
                                                                       ...
                                                                       'items' => [
                                                                                    ...
                                                                                    bless( {
                                                                                             'subrule' => '_alternation_1_of_production_1_of_rule_type',
                                                                                             'matchrule' => 0,
                                                                                             'implicit' => 'builtin_field, or var_name',
                                                                                             'argcode' => undef,
                                                                                             'lookahead' => 0,
                                                                                             'line' => 210
                                                                                           }, 'Parse::RecDescent::Subrule' )
